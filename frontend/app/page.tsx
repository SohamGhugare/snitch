...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center bg-black">
      ...
      <div className="w-full min-h-screen flex flex-col items-center justify-start relative bg-[#00110a]">
        ...
        {/* Content Container */}
        <div className="flex flex-col items-center justify-start w-full max-w-7xl mx-auto pt-24 px-4 pb-12 z-10 gap-12">
